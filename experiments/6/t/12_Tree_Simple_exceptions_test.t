...
## ----------------------------------------------------------------------------
## Exception Tests for Tree::Simple:XS
## ----------------------------------------------------------------------------

use Tree::Simple:XS;

my $BAD_OBJECT = bless({}, "Fail");
my $TEST_SUB_TREE = Tree::Simple:XS->new("test");
...
throws_ok {
	Tree::Simple:XS->new("test", 0);
} qr/^Insufficient Arguments \:/, '... this should die';

# not giving a proper argument for parent
throws_ok {
	Tree::Simple:XS->new("test", []);
} qr/^Insufficient Arguments \:/, '... this should die';

# not giving a proper argument for parent
throws_ok {
	Tree::Simple:XS->new("test", $BAD_OBJECT);
} qr/^Insufficient Arguments \:/, '... this should die';
...
throws_ok {
	$tree->addChild("fail");
} qr/^Insufficient Arguments \: Child must be a Tree\:\:Fast object/, '... this should die';
...
# passing non-Tree::Simple:XS::Visitor arg to accept
throws_ok {
...
# is not a Tree::Simple:XS object
throws_ok {
...
## ----------------------------------------------------------------------------
## end Exception Tests for Tree::Simple:XS
## ----------------------------------------------------------------------------	

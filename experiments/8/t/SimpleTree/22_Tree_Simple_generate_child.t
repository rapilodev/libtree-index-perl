...
my($root) = Tree::Simple:XS -> new('Root', Tree::Simple:XS -> ROOT);

isa_ok($root, 'Tree::Simple:XS');
...
for my $i (1 .. 2)
{
	isa_ok($root -> getChild($i - 1), 'Tree::Simple:XS', "Child $i");
...
isa_ok($root -> getChild(0) -> getChild(0), 'Tree::Simple:XS', 'Child 1 of Child 1');
